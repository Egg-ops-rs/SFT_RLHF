...
TRAIN_DATA_PATHS = ["/root/autodl-tmp/data/sft/deepspeek_multi_turn_dataset_200.jsonl","/root/autodl-tmp/data/sft/deepspeek_sft_dataset_2000.jsonl","/root/autodl-tmp/data/sft/deepspeek_sft_dataset_500.jsonl"]
VAL_DATA_PATH = "/root/autodl-tmp/data/sft/deepspeek_sft_dataset_300.jsonl"  # 验证数据集：用于评估模型训练效果
